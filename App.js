...
import WorkspaceMessagesScreen from './screens/WorkspaceMessagesScreen';
...
import DirectMessageDetails from './screens/DirectMessageDetails';
import WorkspaceMessaging from './screens/WorkspaceMessaging';
import WorkspaceChatDetails from './screens/WorkspaceChatDetails';
...
function HomeTabs() {
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        name="Workspace"
        component={WorkspaceMessagesScreen}
        options={{ headerShown: false }}
      />
      <Tab.Screen
        name="Groups"
      ...
      <NavigationContainer>
        {appReady ? (
          <Stack.Navigator>
            ...
            />
            <Stack.Screen
              name="WorkspaceMessaging"
              component={WorkspaceMessaging}
              options={{ headerShown: true }}
            />
            <Stack.Screen
            ...
            />
            <Stack.Screen
              name="WorkspaceChatDetails"
              component={WorkspaceChatDetails}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="DirectMessageDetails"
              component={DirectMessageDetails}
              options={{ headerShown: false }}
            />
            <Stack.Screen
