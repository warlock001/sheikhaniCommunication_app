import { StyleSheet, TouchableOpacity, TouchableWithoutFeedback, Keyboard, Text, View, KeyboardAvoidingView, Pressable, FlatList, Image } from 'react-native'
            ...
            <SafeAreaView style={styles.chatscreen}>
                <View style={{ marginTop: 13 }}>
                    ...
                    <View
                        ...
                        <Text style={{ marginBottom: 10 }}>Search users in your department</Text>
                        {
                            searchedUsers ? (
