...
const Profile = () => {
  ...
  useEffect(() => {
    async function getProfilePictureURL() {
      ...
      axios
        .get(`https://api.sheikhanigroup.com/files/${profilepicture}/true`)
        .then(res => {
          setprofilepictureURL(
            `data:${res.headers['content-type']};base64,${res.data}`.replace(
              ' ',
              '',
            ),
          );
  ...
  async function sendData() {
    if (!image) {
      ...
      await axios({
        timeout: 20000,
        method: 'POST',
        url: `https://api.sheikhanigroup.com/profilepicture`,
        data: form,
        headers: {
        ...
        .then(async res => {
          ...
          await axios
            ...
            .then(res => {
              ...
              console.log('picta', picta);
              setprofilepictureURL(picta);
              toggleEditModal();
            });
